...
(function () {
  ...
  var DEFAULTS = {
    ...
    nav: [
      ...
      { href: 'over.html', label: 'Over' },
      { href: 'contact.html', label: 'Contact' }
    ],
    footer: {
      tagline: 'Een korte pay-off over je merk.',
      columns: [
      ...
      bottom: '© 2026 Nieuwe site'
    },
    social: [],
    whatsapp: { number: '', text: '', label: '' }
  };
